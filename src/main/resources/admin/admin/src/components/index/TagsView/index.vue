<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"0","boxShadow":"none","margin":"0 0 0 8px","borderColor":"#f5f5f5","display":"block","overflow":"hidden","top":"73px","background":"#2f4050","borderWidth":"8px 0 0","width":"calc(100% - 44px)","fontSize":"14px","lineHeight":"32px","position":"fixed","borderStyle":"solid","height":"40px","zIndex":"9"}'>
		<scroll-pane ref="scrollPane" class="tags-view-wrapper">
			<div class="tags-view-box" :style='{"padding":"0","borderColor":"#ddd","whiteSpace":"nowrap","background":"none","borderWidth":"0px","width":"auto","position":"relative","borderStyle":"solid"}'>
