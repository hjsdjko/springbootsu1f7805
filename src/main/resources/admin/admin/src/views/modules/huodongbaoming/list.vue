				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('huodongbaoming','评价建议')" @click="huodongpingjiaCrossAddOrUpdateHandler(scope.row,'cross','否','','','')" type="success">
    ...
    getDataList() {
      ...
      let params = {
        ...
        order: 'desc',
          ...
          if(this.searchForm.huodongrenshu!='' && this.searchForm.huodongrenshu!=undefined){
            params['huodongrenshu'] = this.searchForm.huodongrenshu
          }
