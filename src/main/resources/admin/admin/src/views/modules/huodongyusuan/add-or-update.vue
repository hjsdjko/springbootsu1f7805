	...
	<div class="addEdit-block" :style='{"minHeight":"calc(100vh - 200px)","padding":"10px 0 30px","margin":"0 auto","color":"#666","background":"none","width":"calc(100% - 20px)","fontSize":"14px","height":"100%"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="活动预算" prop="huodongyusuan">
					<el-input-number v-model="ruleForm.huodongyusuan" placeholder="活动预算" :disabled="ro.huodongyusuan"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-else class="input" label="活动预算" prop="huodongyusuan">
					<el-input v-model="ruleForm.huodongyusuan" placeholder="活动预算" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="登记时间" prop="dengjishijian">
					<el-date-picker
				...
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.dengjishijian" label="登记时间" prop="dengjishijian">
					<el-input v-model="ruleForm.dengjishijian" placeholder="登记时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-if="type!='info'"  label="预算详情" prop="yusuanxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.yusuanxiangqing" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.yusuanxiangqing" label="预算详情" prop="yusuanxiangqing">
                    <span :style='{"fontSize":"12px","lineHeight":"24px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.yusuanxiangqing"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='huodongyusuan'){
							this.ruleForm.huodongyusuan = obj[o];
							this.ro.huodongyusuan = true;
							continue;
						}
						if(o=='dengjishijian'){
						...
						if(o=='yusuanxiangqing'){
							this.ruleForm.yusuanxiangqing = obj[o];
							this.ro.yusuanxiangqing = true;
							continue;
						}
				}
			}
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.yusuanxiangqing = this.ruleForm.yusuanxiangqing.replace(reg,'../../../springbootsu1f7805/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `huodongyusuan/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.huodongyusuanCrossAddOrUpdateFlag = false;
											this.parent.search();
