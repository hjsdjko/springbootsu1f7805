	...
	<div class="addEdit-block" :style='{"minHeight":"calc(100vh - 200px)","padding":"10px 0 30px","margin":"0 auto","color":"#666","background":"none","width":"calc(100% - 20px)","fontSize":"14px","height":"100%"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="报名人数" prop="huodongrenshu">
					<el-select :disabled="ro.huodongrenshu" v-model="ruleForm.huodongrenshu" placeholder="请选择报名人数" >
						<el-option
							v-for="(item,index) in huodongrenshuOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-else class="input" label="报名人数" prop="huodongrenshu">
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.huodongrenshuOptions = "1".split(',')
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      ...
	      objcross.huodongrenshu = parseFloat(objcross.huodongrenshu) + parseFloat(this.ruleForm.huodongrenshu)
                }
      //更新跨表属性
       var crossuserid;
       var crossrefid;
