	...
	<div class="addEdit-block" :style='{"minHeight":"calc(100vh - 200px)","padding":"10px 0 30px","margin":"0 auto","color":"#666","background":"none","width":"calc(100% - 20px)","fontSize":"14px","height":"100%"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="活动类型" prop="huodongleixing">
				...
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="活动时间" prop="huodongshijian">
					<el-input v-model="ruleForm.huodongshijian" placeholder="活动时间" clearable  :readonly="ro.huodongshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-else class="input" label="活动时间" prop="huodongshijian">
					<el-input v-model="ruleForm.huodongshijian" placeholder="活动时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="计划时间" prop="jihuashijian">
					<el-date-picker
				...
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.jihuashijian" label="计划时间" prop="jihuashijian">
					<el-input v-model="ruleForm.jihuashijian" placeholder="计划时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="upload" v-if="type!='info'&& !ro.jihuawendang" label="计划文档" prop="jihuawendang">
					<file-upload
						tip="点击上传计划文档"
						action="file/upload"
						:limit="1"
						:type="3"
						:multiple="true"
						:fileUrls="ruleForm.jihuawendang?ruleForm.jihuawendang:''"
						@change="jihuawendangUploadChange"
					></file-upload>
				</el-form-item>  
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.jihuawendang" label="计划文档" prop="jihuawendang">
					<el-button :style='{"border":"1px solid #ccc","cursor":"pointer","padding":"0 10px","margin":"0 20px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"#f6f6f6","width":"auto","lineHeight":"30px","fontSize":"12px","height":"30px"}' type="text" size="small" @click="download($base.url+ruleForm.jihuawendang)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-else-if="!ruleForm.jihuawendang" label="计划文档" prop="jihuawendang">
				...
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-if="type!='info'"  label="计划简介" prop="jihuajianjie">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.jihuajianjie" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"padding":"0px 0","margin":"0 auto 20px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.jihuajianjie" label="计划简介" prop="jihuajianjie">
                    <span :style='{"fontSize":"12px","lineHeight":"24px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jihuajianjie"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jihuawendang'){
							this.ruleForm.jihuawendang = obj[o];
							this.ro.jihuawendang = true;
							continue;
						}
						if(o=='jihuajianjie'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jihuajianjie = this.ruleForm.jihuajianjie.replace(reg,'../../../springbootsu1f7805/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.jihuawendang!=null) {
		this.ruleForm.jihuawendang = this.ruleForm.jihuawendang.replace(new RegExp(this.$base.url,"g"),"");
	}
var objcross = this.$storage.getObj('crossObj');
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `huodongjihua/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.huodongjihuaCrossAddOrUpdateFlag = false;
											this.parent.search();
    ...
    jihuawendangUploadChange(fileUrls) {
	    this.ruleForm.jihuawendang = fileUrls;
    },
  }
};
</script>
