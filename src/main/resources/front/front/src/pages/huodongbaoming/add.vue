...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="报名人数" prop="huodongrenshu">
            <el-select v-model="ruleForm.huodongrenshu" placeholder="请选择报名人数" :disabled=" false  ||ro.huodongrenshu" >
              <el-option
